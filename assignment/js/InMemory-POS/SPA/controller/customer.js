...
customerValideaction.push({
    reg: cusIDRegEx,
    field: $('#txtCustomerID'),
    error: 'Customer ID Pattern is Wrong : ex :-C00-001'
});
customerValideaction.push({
    reg: cusNameRegEx,
    field: $('#txtCustomerName'),
    error: 'Customer Name Pattern is Wrong : ex :-Kamal'
});
customerValideaction.push({
    reg: cusAddressRegEx,
    field: $('#txtCustomerAddress'),
    error: 'Customer Address Pattern is Wrong : ex :-Galle'
});
customerValideaction.push({
    reg: cusContactRegEx,
    field: $('#txtCustomerSalary'),
    error: 'Customer Contact Pattern is Wrong : ex :-5000'
});

$('#txtCustomerID,#txtCustomerName,#txtCustomerAddress,#txtCustomerAddress,#txtCustomerSalary').on('keyup', function (event) {
    checkCusValidity();
});

$('#txtCustomerID,#txtCustomerName,#txtCustomerAddress,#txtCustomerAddress,#txtCustomerSalary').on('blur', function (event) {
    checkCusValidity();
});
